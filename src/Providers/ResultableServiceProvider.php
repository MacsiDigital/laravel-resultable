...
class ResultableServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'resultable');
        // $this->loadViewsFrom(__DIR__.'/../resources/views', 'resultable');
        ...
        if ($this->app->runningInConsole()) {
            ...
            /*$this->publishes([
                __DIR__.'/../resources/views' => resource_path('views/vendor/resultable'),
            ], 'views');*/

            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/resultable'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/resultable'),
            ], 'lang');*/
